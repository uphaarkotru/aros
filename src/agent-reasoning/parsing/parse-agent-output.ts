import type {AgentOutputParseIssue,AgentOutputParseResult,AgentReasonerResponse} from "@/domain/agent-reasoning/types";import type {AgentType} from "@/domain/agents/types";import type {DecisionCandidate,DecisionClaim,DecisionClaimCertainty,DecisionClaimType,DecisionType} from "@/domain/decisions/types";import {decisionCandidateKnownFields,decisionClaimCertainties,decisionClaimTypes,decisionTypes} from "@/decision-candidate-schema/descriptor";import {reasoningVersions,supportedAgentTypes} from "../config";

const claimTypes:readonly DecisionClaimType[]=decisionClaimTypes,certainties:readonly DecisionClaimCertainty[]=decisionClaimCertainties,knownFields:readonly string[]=decisionCandidateKnownFields;
