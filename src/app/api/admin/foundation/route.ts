...
export async function POST(request: Request) {
  ...
  if(identityCommands){
    ...
    try{
      ...
      else if(action==="revenue-team")value=await identityCommands.assignRevenueTeam({organizationId,accountId:body.accountId?String(body.accountId):null,opportunityId:body.opportunityId?String(body.opportunityId):null,membershipId:String(body.membershipId),roleId:body.roleId?String(body.roleId):null,participationType:String(body.participationType),isPrimaryOwner:body.participationType==="OWNER",audit:audit("REVENUE_TEAM_ASSIGNMENT_CREATED")});
