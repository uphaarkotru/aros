...
import {ContextQualityView} from "@/features/dev/ai-developer-console/context-quality/context-quality-view";
...
export function ContextInspector({twins,contexts,decisions}:{twins:AccountDigitalTwin[];contexts:Record<string,ResolvedAccountContext>;decisions:GovernedDecision[]}){
 ...
 return <article className="context-inspector">
  ...
  {result.context&&<><section className="twin-card"><span className="eyebrow">CONTEXT QUALITY</span><ContextQualityView build={result}/></section><div className="inspector-grid">
