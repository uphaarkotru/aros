...
export type OrganizationStatus =
  "PROVISIONING" | "ACTIVE" | "SUSPENDED" | "ARCHIVED" | "INACTIVE";
...
export type Methodology =
  "MEDDPICC" | "MEDDIC" | "CHALLENGER" | "SPICED" | "CUSTOM";
...
export interface Organization {
  ...
  defaultMethodology: Methodology | null;
  createdAt: string;
  updatedAt: string;
  version?: number;
}
...
export interface MembershipRoleAssignment {
  ...
  organizationId: string;
  membershipId: string;
  organizationRoleDefinitionId: string;
  isPrimary: boolean;
...
export interface MembershipOrganizationalUnit {
  id: string;
  organizationId: string;
  membershipId: string;
...
export interface RevenueTeamAssignment {
  id: string;
  organizationId: string;
  accountId: string | null;
  opportunityId: string | null;
  membershipId: string;
  organizationRoleDefinitionId: string | null;
...
export interface GovernanceConfiguration {
  organizationId: string;
  autonomyDefault: "RECOMMEND" | "ASSIST";
  requireHumanApproval: boolean;
  managerApprovalCategories: string[];
...
export interface IdentityStore {
  ...
  organizationRoles: OrganizationRoleDefinition[];
  roleAssignments: MembershipRoleAssignment[];
  organizationalUnits: OrganizationalUnit[];
  unitMemberships: MembershipOrganizationalUnit[];
  relationships: OrganizationRelationship[];
  revenueTeamAssignments: RevenueTeamAssignment[];
  invitations: OrganizationInvitation[];
  integrations: TenantIntegration[];
  governanceConfigurations: GovernanceConfiguration[];
  teams: Team[];
  regions: Region[];
  sessions: Session[];
