...
export interface SessionContextValue {user:PublicUser;viewUser:PublicUser;membership:OrganizationMembership;organization:{id:string;name:string;slug:string};permissions:Permission[];scope:{organizationId:string;userIds:string[];accountIds:string[];opportunityIds:string[];teamIds:string[]}|null;applicationMode:ApplicationMode;isViewingAs:boolean;viewAsRole:RevenueRole|null;effectiveRole:RevenueRole}
